...
{
    class EbbsPaymentWoAutoRecordCreator : IAliasRecordCreator<Payment>
    {
        ...
        public EbbsPaymentWoAutoRecordCreator(FileScheduler fileShedular, List<string> ePaymentExcludeCodes, List<string> eWriteoffAccounts)
        {
