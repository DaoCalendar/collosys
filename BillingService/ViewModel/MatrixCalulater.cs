...
namespace BillingService.ViewModel
{
    public class MatrixCalulater
    {
        public static decimal CalculateMatrix<T>(ScbEnums.Products products, string matrixName, List<T> data)
        {
            ...
            var result = CalculateTwoDimentionMatrix<T>(products, matrix, data);
            return result;
        }

        public static decimal CalculateTwoDimentionMatrix<T>(ScbEnums.Products products, BMatrix bMatrix, List<T> data)
        {
            ...
            {
                amount += CustBillViewModelDbLayer.GetBillingSubpolicyAmount(products, bConditions.ToList(), data);
            }
