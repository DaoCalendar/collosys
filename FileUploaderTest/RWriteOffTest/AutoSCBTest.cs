...
{
    public class AutoSCBTest : FileProvider
    {
        #region ctor
        ...
        public void Init()
        {
            ...
            var fileScheduler = mappingData.GetUploadedFile(ColloSysEnums.FileAliasName.R_WRITEOFF_AUTO_SCB);
            _paymentLiner = new RWriteOffAutoScbFR(fileScheduler);
        }
