...
{
    public class SME_Test : FileProvider
    {
        #region ctor
        ...
        public void Init()
        {
            ...
            var fileScheduler = mappingData.GetUploadedFile(ColloSysEnums.FileAliasName.R_WRITEOFF_SME);
            _paymentLiner = new RWriteOffSmeFR(fileScheduler);
        }
