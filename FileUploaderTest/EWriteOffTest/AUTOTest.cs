...
{
    public class AUTOTest : FileProvider
    {
        #region ctor
        ...
        public void Init()
        {
            ...
            var fileScheduler = mappingData.GetUploadedFile(ColloSysEnums.FileAliasName.E_WRITEOFF_AUTO);
            _paymentLiner = new EWriteOffAutoFR(fileScheduler);
        }
