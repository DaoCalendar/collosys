csapp.factory("$csBillingModels", ["$csShared", function ($csShared) {
    ...
    var billingPolicy = function () {
        return {
            ...
            PolicyForStatkeholder: { label: "Stakeholder", type: "select", textField: "Display", valueField: "Id" },
            PolicyForHierarchy: { label: "Hierarchy", type: "select", textField: "Display", valueField: "Id" },
