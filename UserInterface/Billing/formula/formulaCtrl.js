...
(csapp.controller("formulaCtrl", ["$scope", "$csnotify", '$csfactory', "Restangular", function ($scope, $csnotify, $csfactory, rest) {
    "use strict";
    ...
    $scope.changeProductCategory = function () {
        ...
        if (!angular.isUndefined(formula.Products) && !angular.isUndefined(formula.Category)) {
            ...
            //// get formula names
            //restApi.customGET("GetFormulaNames", { product: formula.Products, category: formula.Category }).then(function (data) {
            ...
            //// get formula names
            //restApi.customGET("GetMatrixNames", { product: formula.Products, category: formula.Category }).then(function (data) {
