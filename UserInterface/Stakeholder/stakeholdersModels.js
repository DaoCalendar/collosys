csapp.factory("$csStakeholderModels", ["$csShared", function ($csShared) {
    ...
    var stkhHierarchy = function () {
        return {
            ...
            HasMultipleAddress: { label: 'HasMultipleAddress', type: 'btn-radio', options: [true, false] },
            HasRegistration: { label: 'HasRegistration', type: 'btn-radio', options: [true, false] },
            HasServiceCharge: { label: 'HasServiceCharge', type: 'btn-radio', options: [true, false] },
