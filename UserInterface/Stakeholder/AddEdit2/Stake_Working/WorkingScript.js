    ...
    function ($scope, rest, $log, $timeout, $csfactory, $csnotify, pincodeMngr, $modal, $csModels) {
        ...
        $scope.openMultiSelectPopUp = function (array) {
            ...
            var modalInstance = $modal.open({
                templateUrl: baseUrl + 'Stakeholder/AddEdit2/Stake_Working/multiselectPopUp.html',
        ...
        $scope.manageDelete = function (index, data) {
            if ($scope.WorkingData.isEditMode) {
                ...
                $modal.open({
                    templateUrl: baseUrl + 'Stakeholder/AddEdit2/Stake_Working/DeleteWorkingPopUp.html',
