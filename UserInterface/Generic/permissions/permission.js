...
csapp.controller("PermissionscreenCtrl",
    ["$scope", "$csfactory", "$csnotify", "Restangular", "$log", "PermissionsDatalayer", "PermissionsFactory", '$csModels',
        function ($scope, $csfactory, $csnotify, rest, $log, datalayer, factory, $csModels) {
            "use strict";
