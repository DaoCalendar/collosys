...
//scope.$watch('gridOptions.customSort.directions', function (newVal, oldVal) {
//    if (newVal !== oldVal) {
//        $log.debug("$csgrid: sorting options changed ");
//        serverData.GetGridData(scope.gridOptions);
//    }
//}, true);
//scope.$watch('gridOptions.$gridScope.filterText', function (newVal, oldVal) {
//    if (angular.isUndefined(scope.gridOptions.$gridScope)) return;
//    scope.gridOptions.filtering.filterText = scope.gridOptions.$gridScope.filterText;
//    if (newVal !== oldVal) {
//        $log.debug("$csgrid: filtering options changed ");
//        serverData.GetGridData(scope.gridOptions);
//    }
//}, true);
//scope.$watch('gridOptions.filtersArray', function (newVal, oldVal) {
//    if (newVal !== oldVal) {
//        $log.debug("$csgrid: advanced filtering options changed ");
//        serverData.GetGridData(scope.gridOptions);
//    }
//}, true);
//var filterBarPlugin = {
...
//    scope.$watch('gridOptions.showGrid', function (newVal, oldVal) {
//        if (newVal !== oldVal) {
//            $log.debug("$csgrid: trying to refresh the grid ");

//            if (angular.isUndefined(scope.gridOptions.showGrid) || (scope.gridOptions.showGrid !== true)) {
//                $log.debug("$csgrid: grid is yet to get its all parameters ");
//                return;
//            }
//            if (!$scope.$$phase) {
//                $log.info("$csgrid: refreshing the grid ");
//                $scope.$apply();
//            }
//        }
//    }, true);
