...
namespace ColloSys.UserInterface.Areas.Allocation.apiController
{
    public class AllocationsController : ApiController
    {
        ...
        [HttpPost]
        [HttpTransaction]
        public IEnumerable<AllocListModel2> GetAllocations(DataModel2 model)
        {
            ...
            var allocListModel = new AllocListModel2();
        ...
        [HttpGet]
        [HttpTransaction]
        public Array GetAllocationStatus()
        {
            var values= Enum.GetValues(typeof (ColloSysEnums.AllocStatus));
            return values;
        }
    }
}
