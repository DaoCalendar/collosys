    ...
    public class ApproveEditedErrorDataApiController : ApiController
    {
        ...
        public HttpResponseMessage PostRows(JObject value)
        {
            try
            {
                ...
                var errorDataRows = serializer.Deserialize<IEnumerable<object>>(dictionary["data"].ToString()).ToArray();
                //var errorDataRows = errorDataJObjects.Select(c => c.ToObject<Dictionary<string, object>>());
