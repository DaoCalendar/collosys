...
csapp.factory("radioButtonFactory", ["$csfactory", function ($csfactory) {
...
csapp.factory("emailFactory", ["$csfactory", function ($csfactory) {
    var geTemplate = function (scope) {
...
csapp.factory("checkboxFactory", ["$csfactory", function ($csfactory) {
